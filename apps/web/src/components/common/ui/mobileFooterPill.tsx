    ...
    return (
        <>
            ...
            <div className="relative z-40 flex flex-col items-end gap-3">
                {isOpen && (
                    <div
                        className="flex flex-col gap-0 bg-brand-bg-secondary rounded-2xl overflow-hidden shadow-elevation-3 w-[min(90vw,360px)]">
                ...
                <button
                    ...
                    className={`w-16 h-16 flex items-center justify-center rounded-3xl transition-all duration-200 cursor-pointer shadow-elevation-4 hover:shadow-elevation-5 ${isOpen
                        ? 'bg-brand-accent text-brand-bg-secondary'
                        : 'bg-brand-bg-secondary text-white hover:bg-brand-bg-quaternary'
                    }`}
