...
public class CommunityPostServiceTests
{
    ...
    public async Task CreatePostAsync_SavesPostToDatabase_AndReturnsEntity()
    {
        ...
        var saved = await dbContext.CommunityPosts.FindAsync(result.Id);
    ...
    public async Task GetPostByIdAsync_ReturnsCorrectPostOrNull()
    {
        ...
        var post = new CommunityPost { Id = Guid.NewGuid(), UserId = Guid.NewGuid(), Title = "Title", Body = "Body", CreatedAt = DateTime.UtcNow };
    ...
    public async Task GetPostsAsync_ReturnsAllPosts_SortedByDateDescending_WithUserDetails()
    {
        ...
        var post1 = new CommunityPost { Id = Guid.NewGuid(), UserId = user.Id, Title = "Title 1", Body = "Body 1", CreatedAt = DateTime.UtcNow.AddMinutes(-10) };
        var post2 = new CommunityPost { Id = Guid.NewGuid(), UserId = user.Id, Title = "Title 2", Body = "Body 2", CreatedAt = DateTime.UtcNow };
