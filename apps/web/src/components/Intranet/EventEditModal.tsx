      ...
      <form onSubmit={onSubmit} className="bg-surface rounded-3xl shadow-2xl border-0 w-full max-w-md overflow-hidden flex flex-col animate-in zoom-in-95">
        <div className="flex justify-between items-center bg-surface px-6 py-5 pb-2">
          <h3 className="text-base font-bold text-on-surface flex items-center gap-2">
            <Edit size={20} className="text-on-surface-variant" /> Edit Calendar Event
          </h3>
        ...
        <div className="bg-surface px-6 py-5 flex justify-end gap-2">
          ...
          <button type="submit" className="bg-brand-btn-primary hover:bg-brand-btn-quaternary text-white text-sm font-bold px-5 py-2.5 rounded-full transition shadow-md hover:shadow-lg cursor-pointer">Save Changes</button>
        </div>
      </form>
    </div>
  );
