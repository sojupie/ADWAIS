...
export function KioskControls() {
  ...
  return (
    <div className="flex items-center gap-1">
      <div className={`flex items-center justify-between w-[180px] px-3 py-1.5 border rounded-sm shadow-sm transition-colors duration-500 whitespace-nowrap shrink-0
