  ...
  return (
    <Link
      ...
      className={variant === 'mobile'
        ? 'flex items-center px-2.5 py-1 rounded-md text-xs font-bold text-slate-300 bg-brand-bg-primary/45 border border-white/10 hover:bg-brand-bg-primary/60 transition-colors whitespace-nowrap shrink-0 max-w-[120px] truncate'
