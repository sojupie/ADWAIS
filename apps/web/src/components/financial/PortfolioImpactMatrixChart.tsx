  ...
  const options: ChartOptions<'bubble'> = {
    ...
    scales: {
      x: { 
        ...
        grid: horizontalGrid, 
        title: { display: true, text: 'Portfolio revenue share (%) →', color: chartColor('--color-chart-label', '#475569'), font: { family: 'Noto Sans, sans-serif', size: 14, weight: 800 } }, 
        ticks: { ...chartTick(14), callback: value => `${Number(value).toFixed(1)}%` } 
      },
      y: { 
        border: { display: false }, 
        grid: horizontalGrid, 
        title: { display: true, text: 'Revenue growth (%) →', color: chartColor('--color-chart-label', '#475569'), font: { family: 'Noto Sans, sans-serif', size: 14, weight: 800 } }, 
