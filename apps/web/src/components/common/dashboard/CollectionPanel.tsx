...
export function CollectionPanel({ title, actions, className = '', isLoading, children }: CollectionPanelProps) {
  return (
    <section className={`bg-surface rounded-2xl p-0 flex flex-col min-h-0 overflow-hidden max-h-[600px] xl:max-h-none contained:max-h-none landscape-lg:max-h-none ${className}`}>
